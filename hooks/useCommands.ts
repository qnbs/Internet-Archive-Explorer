...
export const useCommands = (actions: CommandActions): Command[] => {
  ...
  const commands = useMemo(() => {
    ...
    const navigationCommands: Command[] = [
      ...
      { id: 'nav-uploaderhub', section: t('commandPalette:sections.navigation'), label: t('sideMenu:uploaderHub'), description: t('commandPalette:nav.uploaderHubDesc'), icon: React.createElement(UsersIcon, { className: iconClass }), action: () => actions.navigateTo('uploaderHub'), keywords: 'community contributors people' },
      ...
      { id: 'nav-webarchive', section: t('commandPalette:sections.navigation'), label: t('sideMenu:webArchive'), description: t('commandPalette:nav.webArchiveDesc'), icon: React.createElement(WebIcon, { className: iconClass }), action: () => actions.navigateTo('web'), keywords: 'wayback machine websites history' },
