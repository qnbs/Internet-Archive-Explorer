...
const TabButton: React.FC<{
  ...
  setActiveTab: (tab: ItemDetailTab) => void;
  uniqueId: string;
}> = ({ tab, label, activeTab, setActiveTab, uniqueId }) => (
  <button
    id={`${uniqueId}-tab-${tab}`}
    role="tab"
...
export const ItemDetailTabs: React.FC<ItemDetailTabsProps> = ({
  activeTab,
  setActiveTab,
  showAiTab,
  uniqueId,
  ...
  return (
    <div
      ...
      className="flex items-center space-x-2 bg-gray-100 dark:bg-gray-900/50 p-1.5 rounded-xl border border-gray-200 dark:border-gray-700/50"
    >
      <TabButton
        tab="description"
