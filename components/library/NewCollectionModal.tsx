...
export const NewCollectionModal: React.FC<NewCollectionModalProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-gray-800 w-full max-w-md rounded-xl shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        <header className="flex items-center justify-between p-4 border-b border-gray-700">
          <h2 id="new-collection-title" className="text-lg font-bold text-white">
            {t('favorites:modals.newCollectionTitle')}
          </h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            ...
            >
              {t('favorites:modals.newCollectionName')}
            </label>
            <input
              ref={inputRef}
              id="collection-name"
