...
import { InfoIcon, PauseIcon, PlayIcon, PlusIcon } from '@/components/Icons';
      ...
      <div className="relative aspect-square bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-cyan-500/30 transition-shadow duration-300">
        ...
        <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            ...
            title={t('audiothek:player.addToQueue')}
            className="p-2 bg-black/50 hover:bg-cyan-500/80 rounded-full text-white transition-colors"
          >
