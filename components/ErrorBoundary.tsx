...
class ErrorBoundary extends React.Component<Props, State> {
  ...
  private handleReset = () => {
    if (window.confirm("Warning: This will reset all your personalized settings, favorites, and cached data to fix the application state. Are you sure you want to proceed?")) {
        // Aggressively clear all application-related keys
        Object.keys(localStorage).forEach((key) => {
            if (key.startsWith('app-') || key.startsWith('scriptorium-') || key.startsWith('ai-archive-') || key.includes('jotai')) {
      ...
      return (
        <div className="fixed inset-0 flex flex-col justify-center items-center bg-gray-900 text-white p-6 text-center z-[100] overflow-hidden animate-fade-in">
          ...
          <div className="relative z-10 flex flex-col items-center max-w-lg w-full">
              ...
              <h1 className="text-3xl font-bold text-white mb-3 tracking-tight">System Encountered an Error</h1>
              <p className="text-gray-400 mb-8 text-lg leading-relaxed">
                The application has crashed due to an unexpected issue. You can try reloading, or perform a hard reset if the issue persists.
              </p>
              ...
              {this.state.error && (
                <div className="mt-10 w-full">
                    <div className="text-xs font-mono text-gray-500 uppercase tracking-wider mb-2 text-left ml-1">Error Details</div>
