...
import { JoystickIcon, StarIcon, FileIcon, CloseIcon } from './Icons';
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 space-y-4">
                <div className="flex items-center space-x-2 border-b border-gray-700 pb-2">
                    ...
                    {item.mediatype === 'texts' && <TabButton tab="ai" label={t('common.aiAnalysis')} />}
                ...
                <div className="pt-2">
                    ...
                    {activeTab === 'ai' && item.mediatype === 'texts' && (
                        <AIToolsTab 
