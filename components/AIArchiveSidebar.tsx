  ...
  [
    {
      ...
      labelKey: 'aiArchive:types.summary',
      icon: <BookIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.Entities,
      labelKey: 'aiArchive:types.entities',
      icon: <TagIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.ImageAnalysis,
      labelKey: 'aiArchive:types.imageAnalysis',
      icon: <ImageIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.DailyInsight,
      labelKey: 'aiArchive:types.dailyInsight',
      icon: <StarIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.Story,
      labelKey: 'aiArchive:types.story',
      icon: <SparklesIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.Answer,
      labelKey: 'aiArchive:types.answer',
      icon: <SparklesIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.MagicOrganize,
      labelKey: 'aiArchive:types.magicOrganize',
      icon: <SparklesIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.MoviesInsight,
      labelKey: 'aiArchive:types.moviesInsight',
      icon: <MovieIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.AudioInsight,
      labelKey: 'aiArchive:types.audioInsight',
      icon: <AudioIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.ImagesInsight,
      labelKey: 'aiArchive:types.imagesInsight',
      icon: <ImageIcon className="w-4 h-4" />,
    },
    {
      type: AIGenerationType.RecRoomInsight,
      labelKey: 'aiArchive:types.recRoomInsight',
      icon: <JoystickIcon className="w-4 h-4" />,
    },
  ];
...
export const AIArchiveSidebar: React.FC<AIArchiveSidebarProps> = ({
  filter,
  setFilter,
  searchQuery,
  setSearchQuery,
