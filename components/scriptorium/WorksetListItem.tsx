...
import { ArrowRightIcon, PencilAltIcon, TrashIcon } from '@/components/Icons';
...
export const WorksetListItem: React.FC<WorksetListItemProps> = ({
  workset,
  onSelect,
  onDelete,
  onRename,
    ...
    >
      <div>
        ...
        <p className="text-sm text-gray-400">
          {t('scriptorium.documentCount', { count: workset.documents.length })}
        </p>
      </div>
