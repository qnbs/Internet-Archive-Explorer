...
export const UploaderFavoritesTab: React.FC = () => {
  ...
  const filteredProfiles = useMemo(() => {
    ...
    return favoriteUploaderProfiles.filter(
      (profile) => profile && profile.name.toLowerCase().includes(lowerQuery),
    );
    ...
    <div className="space-y-6">
      <div className="relative">
        ...
        <input
          ...
          placeholder={t('favorites:searchUploadersPlaceholder', {
            count: favoriteUploaderProfiles.length,
          })}
