  ...
  return (
    <div className="bg-white dark:bg-gray-800/60 p-4 rounded-xl border border-gray-200 dark:border-gray-700/50">
      <div className="w-full overflow-x-auto">
        <div
          className="inline-flex flex-nowrap gap-2 bg-gray-100 dark:bg-gray-900/50 p-1.5 rounded-xl"
          role="tablist"
          aria-label={t('uploaderDetail:aria.profileSections')}
        >
      ...
      <div
        className={`grid transition-all duration-300 ease-in-out ${activeTab === 'uploads' ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}
      >
