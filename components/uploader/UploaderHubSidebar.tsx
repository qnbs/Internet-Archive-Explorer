            ...
            <div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-gray-100 dark:bg-gray-700/80 border-2 border-transparent focus-within:border-cyan-500 rounded-lg py-2 pl-10 pr-4 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none transition-colors"
