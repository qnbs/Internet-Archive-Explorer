...
const UploaderDetailView: React.FC<UploaderDetailViewProps> = ({
  profile,
  onBack,
  returnView,
  isMyArchiveView,
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'collections':
        return (
          <div className={tabContentWrapperClass}>
            <UploaderCollections profile={profile} />
          </div>
        );
      case 'favorites':
        return (
          <div className={tabContentWrapperClass}>
            <UploaderFavorites profile={profile} />
          </div>
        );
      case 'reviews':
        return (
          <div className={tabContentWrapperClass}>
            <UploaderReviewsTab profile={profile} />
          </div>
        );
      case 'posts':
        return (
          <div className={tabContentWrapperClass}>
            <UploaderPostsTab profile={profile} />
          </div>
        );
      case 'webArchive':
        return (
          <div className={tabContentWrapperClass}>
            <UploaderWebArchiveTab profile={profile} />
          </div>
        );
      default:
        return null;
