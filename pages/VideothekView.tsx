...
const getCollections = (t: (key: string) => string) => [
  {
    key: 'newly_added',
    title: t('videothek:collections.newly_added'),
    query: `mediatype:(${MediaType.Movies})`,
  },
  ...
  {
    key: 'sci_fi',
    title: t('videothek:collections.sci_fi'),
    query: 'subject:"science fiction" AND mediatype:(movies)',
  },
  {
    key: 'animation',
    title: t('videothek:collections.animation'),
    query: 'collection:animationandcartoons',
  },
  {
    key: 'silent_films',
    title: t('videothek:collections.silent_films'),
    query: 'subject:"silent film" AND mediatype:(movies)',
  },
];
  ...
  return (
    ...
    >
      ...
      {collections.map((collection) => (
        <ArchivalCarousel key={collection.key} title={collection.title} query={collection.query} />
      ))}
    </div>
  );
};
