...
// --- UI State Atoms ---
export const selectedWorksetIdAtom = safeAtomWithStorage<string | null>(
  'scriptorium-selected-workset-id',
  null,
);
export const selectedDocumentIdAtom = safeAtomWithStorage<string | null>(
  'scriptorium-selected-document-id',
  null,
);

// --- Write-only Action Atoms ---

export const createWorksetAtom = atom(null, (get, set, name: string): Workset => {
...
export const deleteWorksetAtom = atom(null, (get, set, id: string) => {
