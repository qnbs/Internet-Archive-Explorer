 ...
 */
export const selectedAIEntryIdAtom = safeAtomWithStorage<string | null>(
  'ai-archive-selected-id',
  null,
);
 ...
 */
export const aiArchiveFilterAtom = safeAtomWithStorage<AIArchiveFilter>('ai-archive-filter', {
  type: 'all',
});
 ...
 * This is persisted to localStorage.
 */
export const aiArchiveSortAtom = safeAtomWithStorage<AIArchiveSortOption>(
  'ai-archive-sort',
  'timestamp_desc',
);
 ...
 */
export const addAIArchiveEntryAtom = atom(null, (get, set, newEntry: AIArchiveEntry) => {
 ...
 */
export const deleteAIArchiveEntryAtom = atom(null, (get, set, entryId: string) => {
