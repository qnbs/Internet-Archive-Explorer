...
export const settingsAtom = safeAtomWithStorage<AppSettings>(
...
export const defaultUploaderDetailTabAtom = selectAtom(
  settingsAtom,
  (s) => s.defaultUploaderDetailTab,
);
...
export const autoRunEntityExtractionAtom = selectAtom(
  settingsAtom,
  (s) => s.autoRunEntityExtraction,
);
